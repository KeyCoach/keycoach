    ...
    <div className={`flex flex-col space-y-1 ${containerWidth}`}>
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          } text-md w-full rounded-md border border-slate-300 bg-slate-200 bg-opacity-20 px-3 py-2 text-slate-800 placeholder-slate-400 transition duration-200 ease-in-out focus:border-cerulean-500 focus:ring focus:ring-cerulean-300 focus:ring-opacity-50 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 dark:placeholder-slate-300 ${className}`}
          id={id}
          {...props}
        />
        {addonPosition === "right" && (
