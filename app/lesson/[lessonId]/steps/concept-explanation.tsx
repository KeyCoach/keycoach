            ...
            <div className="md:w-3/5">
              <div className="bg-white dark:bg-slate-700 p-6 rounded-xl shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-semibold text-cerulean-700 dark:text-cerulean-300 ml-3">
                        ...
                        {keyboardRows.map((row, rowIndex) => (
                          <div key={rowIndex} className="flex mb-1">
                            {row.map((key) => (
                              <div
                                key={key}
                                className={`w-8 h-8 mx-0.5 rounded flex items-center justify-center text-xs border-2 ${
                                  key === lessonId.toLowerCase() 
                                  ? 'border-cerulean-500 bg-cerulean-100 dark:bg-cerulean-800 font-bold' 
...
function getKeyExplanation(key: string): KeyExplanation {
  const explanations: ExplanationsMap = {
    "a": {
      fingerPosition: "The 'A' key should be pressed with your left pinky finger. When your hands are at the home row position (ASDF JKL;), your left pinky rests on the 'A' key.",
      importance: "The letter 'A' is the second most common letter in the English language. Learning to type it efficiently with your pinky finger builds strength in your weakest finger and improves overall typing speed for common words.",
      tips: [
    ...
    "s": {
      fingerPosition: "The 'S' key should be pressed with your left ring finger. Your left ring finger naturally rests on this key in the home row position.",
      importance: "The 'S' is the 8th most common letter in English, appearing at the beginning of many words and as a plural marker. Mastering this key will significantly improve your typing flow.",
      tips: [
    ...
    "d": {
      fingerPosition: "The 'D' key should be pressed with your left middle finger. This finger naturally rests on this key in the home row position.",
      importance: "The 'D' is a commonly used consonant that begins many English words. Strong command of this key improves your ability to type frequent words like 'do', 'day', and 'different'.",
      tips: [
    ...
    "f": {
      fingerPosition: "The 'F' key should be pressed with your left index finger. This is a home row key, and your left index finger should rest on it by default.",
      importance: "The 'F' key is not only important for typing words with 'f', but it's also a tactile guide for hand positioning. The small bump on this key helps you find the home row without looking.",
      tips: [
    ...
    "g": {
      fingerPosition: "The 'G' key should be pressed with your left index finger by reaching slightly to the right from its home position on the 'F' key.",
      importance: "The 'G' key requires your index finger to leave its home position temporarily, building finger independence and dexterity. This movement pattern is essential for faster typing.",
      tips: [
    ...
    "h": {
      fingerPosition: "The 'H' key should be pressed with your right index finger by reaching slightly to the left from its home position on the 'J' key.",
      importance: "The 'H' is a frequent consonant in English, appearing in many common words and in the 'th' digraph. Mastering this key improves your overall typing speed for everyday communication.",
      tips: [
    ...
    "j": {
      fingerPosition: "The 'J' key should be pressed with your right index finger. This is a home row key, and your right index finger should rest on it by default.",
      importance: "Like the 'F' key, 'J' has a small raised bump to help with touch typing. It serves as the anchor for your right hand and proper finger positioning without looking at the keyboard.",
      tips: [
    ...
    "k": {
      fingerPosition: "The 'K' key should be pressed with your right middle finger. This finger naturally rests on this key in the home row position.",
      importance: "The 'K' key builds right hand dexterity and appears in many common English words. Mastering this key contributes to balanced hand usage while typing.",
      tips: [
    ...
    "l": {
      fingerPosition: "The 'L' key should be pressed with your right ring finger. Your right ring finger naturally rests on this key in the home row position.",
      importance: "The 'L' is the 11th most common letter in English. It appears in many frequent words and common word endings, making it crucial for fluid typing.",
      tips: [
    ...
    "q": {
      fingerPosition: "The 'Q' key should be pressed with your left pinky finger by reaching up from its home position on the 'A' key.",
      importance: "While less common than other letters, 'Q' appears in many important English words. Building skill with this key improves your typing fluency for words like 'question', 'quick', and 'quality'.",
      tips: [
    ...
    "w": {
      fingerPosition: "The 'W' key should be pressed with your left ring finger by reaching up from its home position on the 'S' key.",
      importance: "The 'W' is a common letter that begins many English words. Mastering this key improves your typing speed for frequent words like 'with', 'when', and 'work'.",
      tips: [
    ...
    "e": {
      fingerPosition: "The 'E' key should be pressed with your left middle finger by reaching up from its home position on the 'D' key.",
      importance: "The letter 'E' is the most common letter in the English language. Efficient typing of this key is crucial for overall typing speed and fluency.",
      tips: [
    ...
    "r": {
      fingerPosition: "The 'R' key should be pressed with your left index finger by reaching up from its home position on the 'F' key.",
      importance: "The 'R' is the 8th most common letter in English. Mastering this key improves your ability to type common words like 'are', 'or', and 'your'.",
      tips: [
  ...
  return explanations[key.toLowerCase()] || {
