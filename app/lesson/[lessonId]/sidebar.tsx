...
export default function Sidebar({
  ...
  return (
    <aside
      ...
      } border-gray-700 transition-width h-contain absolute top-1/2 ml-8 flex -translate-y-8 transform flex-col text-nowrap rounded-lg border bg-slate-50 text-slate-950 shadow-lg duration-300 dark:bg-slate-950 dark:text-slate-50`}
