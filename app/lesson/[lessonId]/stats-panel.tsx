...
export default function StatsPanel({
  ...
  return (
    <section className="dark:border-gray-300 mr-8 w-contain max-w-md flex-1 text-nowrap rounded-lg border border-slate-950 bg-slate-50 p-4 shadow-lg dark:border-slate-50 dark:bg-slate-950 top-1/2 absolute right-0">
