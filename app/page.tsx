...
export default function Home() {
  return (
    <div className="h-screen bg-gradient-to-b from-cerulean-400 to-obsidian-200 border-none">
          ...
          <div className="space-y-8">
            <div className="flex justify-center space-x-8">
              <Button colorTheme="cerulean">
                <Link className="w-40 block text-white no-underline" href="/lesson">
                  Try a Lesson!
                </Link>
              </Button>

              <Button colorTheme="cerulean">
                <Link className="w-40 block text-white no-underline" href="/typing/test">
                  Test my Speed!
                </Link>
              </Button>
            </div>
      ...
      {/* Clouds */}
      <div className="absolute bottom-0 left-0 w-full min-h-[100px]">
        {" "}
        {/* Added min-height and removed fixed */}
        <Image
